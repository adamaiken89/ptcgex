defmodule Ptcgex.DataFixtures do
  ...
  """
  def unique_card_collector_card_number, do: "some collector_card_number#{System.unique_integer([:positive])}"
  ...
  def card_fixture(attrs \\ %{}) do
    {:ok, card} =
      attrs
      |> Enum.into(%{
        collector_card_number: unique_card_collector_card_number(),
        name: "some name"
      })
      |> Ptcgex.Data.create_card()
